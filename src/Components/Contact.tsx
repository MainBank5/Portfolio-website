    ...
    <div data-name="contact" className="flex flex-col mx-auto py-6 w-full h-full">
      <div className="flex flex-col mx-auto justify-center items-center w-full">
        ...
        <form method="POST" className="flex flex-col w-3/5 h-1/2" action="https://getform.io/f/24139a13-3c0b-448f-86ea-6e60b5be9775" >
          <input name="name" className=" text-black shadow-cyan-400 shadow-sm p-3 rounded-md mt-4" type="text" required placeholder="First Name.." /> <br />
          <input name="email" className=" text-black shadow-cyan-400 shadow-sm  rounded-md  p-3 mt-4 " type="email" required placeholder="email address.." />  <br />
